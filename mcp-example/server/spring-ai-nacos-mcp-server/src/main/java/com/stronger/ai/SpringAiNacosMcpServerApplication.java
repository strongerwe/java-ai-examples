 ...
 * @class SpringAiNacosMcpServerApplication.class
 * @department Platform R&D
 * @date 2025/9/3
 * @desc 启动类
 */
@SpringBootApplication
public class SpringAiNacosMcpServerApplication {

    public static void main(String[] args) {
        SpringApplication.run(SpringAiNacosMcpServerApplication.class, args);
    }
