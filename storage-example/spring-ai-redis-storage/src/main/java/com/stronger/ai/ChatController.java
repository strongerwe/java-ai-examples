...
public class ChatController {
    ...
    private final JedisRedisChatMemoryRepository jedisRedisChatMemoryRepository;
    /**
     * 最多保存100条消息
     */
    ...
    public ChatController(ChatClient.Builder builder,
        ...
        this.jedisRedisChatMemoryRepository = jedisRedisChatMemoryRepository;
    ...
    public List<Message> messages() {
        return jedisRedisChatMemoryRepository.findByConversationId(LOCAL_CONVERSATION_ID);
    }
}
